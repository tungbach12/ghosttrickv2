export const categories = [
  ...
  { id: 2, slug: 'outerwear', name: 'OuterWear' },
];

export const allProducts = [
  { id: 1, title: 'Áo Thun Phom Boxy Phối Viền Cổ In Chữ - AKIKO', price: '240.000₫', originalPrice: null, category: 'tops', subcategory: 'Áo thun', img: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&q=80&w=800', colors: ['#000', '#fff'], salesCount: 150 },
  { id: 2, title: 'Đầm 2 Dây Caro Dáng Chữ A Tùng Đuôi Cá - LAINE', price: '380.000₫', originalPrice: null, category: 'tops', subcategory: 'Đầm xòe', img: 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?auto=format&fit=crop&q=80&w=800', colors: ['#d4a574', '#000'], salesCount: 85 },
  { id: 3, title: 'Áo Sơ Mi Sọc Phom Rộng Phối Túi Đắp Cầu Vai - YERIN', price: '320.000₫', originalPrice: null, category: 'tops', subcategory: 'Áo sơ mi', img: 'https://images.unsplash.com/photo-1496747611176-843222e1e57c?auto=format&fit=crop&q=80&w=800', colors: ['#87CEEB', '#fff'], salesCount: 120 },
  { id: 4, title: 'Chân Váy Ngắn Chữ A Lai Bầu Viền Bèo - ERI', price: '290.000₫', originalPrice: null, category: 'tops', subcategory: 'Chân váy ngắn', img: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&q=80&w=800', colors: ['#000', '#d4a574'], salesCount: 65 },
  { id: 5, title: 'Áo Thun Dài Tay Cổ Lọ - MIRE', price: '250.000₫', originalPrice: null, category: 'tops', subcategory: 'Áo thun', img: 'https://images.unsplash.com/photo-1618354691373-d851c5c3a990?auto=format&fit=crop&q=80&w=800', colors: ['#000', '#8B0000'], salesCount: 190 },
  { id: 6, title: 'Đầm Dây Lụa Dáng Suông Phối Ren - CHERRY', price: '450.000₫', originalPrice: '550.000₫', onSale: true, category: 'tops', subcategory: 'Đầm suông', img: 'https://images.unsplash.com/photo-1485230895905-ec40ba36b9bc?auto=format&fit=crop&q=80&w=800', colors: ['#FFB6C1', '#fff'], salesCount: 210 },
  { id: 7, title: 'Áo Sơ Mi Tay Ngắn Cổ Bẻ - RIO', price: '280.000₫', originalPrice: null, category: 'tops', subcategory: 'Áo sơ mi', img: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&q=80&w=800', colors: ['#fff', '#87CEEB'], salesCount: 95 },
  { id: 8, title: 'Quần Jean Ống Rộng Phối Túi Bảng Nhỏ - MAYA', price: '420.000₫', originalPrice: null, category: 'tops', subcategory: 'Quần jean', img: 'https://images.unsplash.com/photo-1483985988355-763728e1935b?auto=format&fit=crop&q=80&w=800', colors: ['#4169E1', '#000'], salesCount: 75 },
  { id: 9, title: 'Áo Croptop Sát Nách Đan Dây Lưng - HANA', price: '195.000₫', originalPrice: '260.000₫', onSale: true, category: 'tops', subcategory: 'Áo croptop', img: 'https://images.unsplash.com/photo-1539109136881-3be0616acf4b?auto=format&fit=crop&q=80&w=800', colors: ['#fff', '#FFB6C1'], salesCount: 300 },
  { id: 10, title: 'Đầm Body Tay Dài Cổ Vuông - SORA', price: '360.000₫', originalPrice: null, category: 'tops', subcategory: 'Đầm body', img: 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?auto=format&fit=crop&q=80&w=800', colors: ['#000', '#8B0000'], salesCount: 110 },
  { id: 11, title: 'Quần Tây Ống Đứng Lưng Cao - KIRA', price: '350.000₫', originalPrice: null, category: 'tops', subcategory: 'Quần tây', img: 'https://images.unsplash.com/photo-1496747611176-843222e1e57c?auto=format&fit=crop&q=80&w=800', colors: ['#000', '#808080'], salesCount: 140 },
  { id: 12, title: 'Áo Polo Phối Viền Cổ Bẻ - TAKI', price: '275.000₫', originalPrice: null, category: 'tops', subcategory: 'Áo polo', img: 'https://images.unsplash.com/photo-1618354691373-d851c5c3a990?auto=format&fit=crop&q=80&w=800', colors: ['#fff', '#000'], salesCount: 165 },
  { id: 13, title: 'Chân Váy Midi Xếp Ly - NAMI', price: '310.000₫', originalPrice: null, category: 'tops', subcategory: 'Chân váy midi', img: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&q=80&w=800', colors: ['#d4a574', '#000'], salesCount: 45 },
  { id: 14, title: 'Áo Khoác Blazer Dáng Rộng - ZENI', price: '520.000₫', originalPrice: '650.000₫', onSale: true, category: 'outerwear', subcategory: 'Áo blazer', img: 'https://images.unsplash.com/photo-1483985988355-763728e1935b?auto=format&fit=crop&q=80&w=800', colors: ['#000', '#d4a574'], salesCount: 220 },
  { id: 15, title: 'Quần Short Kaki Lưng Thun - YUMI', price: '230.000₫', originalPrice: null, category: 'tops', subcategory: 'Quần short', img: 'https://images.unsplash.com/photo-1485230895905-ec40ba36b9bc?auto=format&fit=crop&q=80&w=800', colors: ['#d4a574', '#fff'], salesCount: 135 },
  { id: 16, title: 'Đầm Maxi Hoa Nhí Dáng Xòe - FLORA', price: '480.000₫', originalPrice: null, category: 'tops', subcategory: 'Đầm maxi', img: 'https://images.unsplash.com/photo-1539109136881-3be0616acf4b?auto=format&fit=crop&q=80&w=800', colors: ['#FFB6C1', '#87CEEB'], salesCount: 55 },
  { id: 17, title: 'Áo Kiểu Tay Phồng Cổ Vuông - MIKU', price: '285.000₫', originalPrice: null, category: 'tops', subcategory: 'Áo kiểu', img: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&q=80&w=800', colors: ['#fff', '#FFB6C1'], salesCount: 175 },
  { id: 18, title: 'Yếm Denim Phối Túi Trước - KANA', price: '340.000₫', originalPrice: null, category: 'tops', subcategory: 'Yếm denim', img: 'https://images.unsplash.com/photo-1496747611176-843222e1e57c?auto=format&fit=crop&q=80&w=800', colors: ['#4169E1', '#87CEEB'], salesCount: 35 },
  { id: 19, title: 'Áo Khoác Dù Unisex Phối Sọc - RIKU', price: '390.000₫', originalPrice: '490.000₫', onSale: true, category: 'outerwear', subcategory: 'Áo khoác dù', img: 'https://images.unsplash.com/photo-1618354691373-d851c5c3a990?auto=format&fit=crop&q=80&w=800', colors: ['#000', '#fff'], salesCount: 250 },
  { id: 20, title: 'Bộ Đồ Dạo Phố Phom Rộng - SUKI', price: '410.000₫', originalPrice: null, category: 'tops', subcategory: 'Bộ đồ dạo phố', img: 'https://images.unsplash.com/photo-1483985988355-763728e1935b?auto=format&fit=crop&q=80&w=800', colors: ['#808080', '#000'], salesCount: 25 },
];

export const vouchers = [
  { id: 1, code: 'FREESHIP50K', desc: 'Giảm 50K phí vận chuyển' },
  { id: 2, code: 'SALE10', desc: 'Giảm 10% đơn từ 500K' },
  { id: 3, code: 'NEWBIE', desc: 'Giảm 50K cho KH mới' },
  { id: 4, code: 'CATCHUP', desc: 'Giảm 20% tối đa 100K' },
];

export const promotions = [
  "Chào mừng bạn đến với Ghosttrick!",
  "Freeship cho đơn hàng từ 500K",
  "Giảm ngay 10% khi đăng ký thành viên",
  "Hàng mới về - Mua ngay kẻo lỡ!"
];
...
export const mockUsers = [
  { id: 1, email: '12', password: '12', name: 'Nguyễn Văn A', phone: '0901234567' }
];
...
export const mockOrders = [
  {
    ...
    status: 'Đã giao',
    items: [
      { productId: 1, title: 'Áo Thun Phom Boxy Phối Viền Cổ In Chữ - AKIKO', quantity: 2, price: '240.000₫', size: 'M', colorIndex: 0 },
      { productId: 11, title: 'Quần Tây Ống Đứng Lưng Cao - KIRA', quantity: 1, price: '350.000₫', size: 'L', colorIndex: 1 }
    ]
  },
  {
    id: 'ORD-1002',
    ...
    status: 'Đang xử lý',
    items: [
      { productId: 6, title: 'Đầm Dây Lụa Dáng Suông Phối Ren - CHERRY', quantity: 1, price: '450.000₫', size: 'S', colorIndex: 0 }
    ]
  }
];
...
export const saleEvents = [
  {
    ...
    description: 'Ưu đãi cực lớn lên đến 50% cho các sản phẩm hot nhất mùa này.',
